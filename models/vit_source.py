...
class VisionTransformer(nn.Module):
    ...
    def pre_process_encoder_input(self, x: torch.Tensor) -> torch.Tensor:
    ...
    def forward(self, x: torch.Tensor):
        self.encoder_input = self.pre_process_encoder_input(x)
        x = self.encoder(self.encoder_input)
